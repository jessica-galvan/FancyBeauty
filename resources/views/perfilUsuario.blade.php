...
@section('content')
  <div class="perfil-container">
      ...
      <div class="nombreUsuario">
          <h3 id="nombreUsuario">{{$usuario['nombre']." ".$usuario['apellido']}};?></h3>
      </div>
      ...
      <div class="caja-botones">
          <form class="editar-button-violeta " action="/editarPerfil" method="post">
              <button type="submit" name="">Editar Perfil</button>
          </form>
          <form class="editar-button-amarillo" action="/cambiarContrasenia" method="post">
